...
class Gitscrum {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Gitscrum_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'GITSCRUM_VERSION' ) ) {
			$this->version = GITSCRUM_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'gitscrum';
	 ...
	 *
	 * - Gitscrum_Loader. Orchestrates the hooks of the plugin.
	 * - Gitscrum_i18n. Defines internationalization functionality.
	 * - Gitscrum_Admin. Defines all hooks for the admin area.
	 * - Gitscrum_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Gitscrum_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Gitscrum_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Gitscrum_Loader    Orchestrates the hooks of the plugin.
	 */
